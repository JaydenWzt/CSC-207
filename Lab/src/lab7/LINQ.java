...
public final class LINQ
{
	...
	{
		for(T t: source)//map through all elements
		{
		...
		return new Iterable<T>()
		{
			public Iterator<T> iterator()
			{
				return new Iterator<T>()
				{
					...
					protected Iterator<? extends T> i = source.iterator();
				};
			}
		};
	}
		...
		return new Iterable<T>()
		{
			public Iterator<T> iterator()
			{
				return new Iterator<T>()
				{
					...
					protected Iterator<? extends T> a = source_a.iterator();
					protected Iterator<? extends T> b = source_b.iterator();
				};
			}
		};
	}
	 ...
	 * @param except The set to exclude if {@code source} or {@code except} is null.
	 */
		...
		return new Iterable<T>()
		{
			public Iterator<T> iterator()
			{
				return new Iterator<T>()
				{
					...
					protected T Next = null;
					protected Iterator<? extends T> Iter = source_a.iterator();
				};
			}
		};
	}
	...
	public static <T> T Max(Iterable<? extends T> source, Comparator<T> cmp)
	{
		...
		if(Count(source) == 0)
			throw new NoSuchElementException();
		Iterator<? extends T> i = source.iterator(); 
		T max = i.next();
		while(i.hasNext())
		{
			T next = i.next();
		...
		return new Iterable<Pair<A,B>>()
		{
			public Iterator<Pair<A,B>> iterator()
			{
				return new Iterator<Pair<A,B>>()
				{
					...
					{
						return new Pair<A,B>(a.next(), b.next());
					}
					
					protected Iterator<? extends A> a = a_source.iterator(); 
					protected Iterator<? extends B> b = b_source.iterator(); 
		...
		return new Iterable<B>()
		{
			public Iterator<B> iterator()
			{
				return new Iterator<B>()
				{
					...
					protected Iterator<Pair<A,B>> i = source.iterator();
				};
			}
		};
	}
			...
			public Iterator<O> iterator()
			{
				return new Iterator<O>()
				{
					...
					public O next()
					{
						...
						return transformation.Evaluate(i.next());
					}
					
					protected Iterator<? extends I> i = source.iterator();
					int [] nums = new int[5];
			...
			public Iterator<O> iterator()
			{
				return new Iterator<O>()
				{
					...
					public O next()
					{
						...
						return pre = transformation.Evaluate(i.next(),pre);
					}
					
					protected O pre = null;
					protected Iterator<? extends I> i = source.iterator();
				};
			}
		};
	...
	public static <T> boolean SequenceEqual(Iterable<? extends T> s1, Iterable<? extends T> s2)
	{
		...
		if(Count(s1) != Count(s2))
			return false;
		Iterator<? extends T> i1 = s1.iterator();
		Iterator<? extends T> i2 = s2.iterator();
		while(i1.hasNext() && i2.hasNext())
		{
			if(i1 ==null ? i2 ==null : !i1.next().equals(i2.next()))
				return false;
		}
		return true;
	}
	...
	public static <T> T Sum(Iterable<? extends T> source, DoubleInputTransformation<T,T> operation)
	{
		...
		for(T t: source)
		{
				prev = operation.Evaluate(prev, t);
		}
		return prev;
	}
			...
			public Iterator<O> iterator()
			{
				return new Iterator<O>()
				{
					...
					public O next()
					{
						...
						return zip.Evaluate(new Pair<A,B>(a.next(), b.next()));
					}
					
					protected Iterator<? extends A> a = source_a.iterator();
					protected Iterator<? extends B> b = source_b.iterator();
				};
			}
		};
	}
