 ...
 * <br><br>
 * Note that no functions check for exceptions to speedup execution, as this matrix is intended for graphical usage.
...
public class Matrix2D
{
	...
	public Matrix2D LeftMultiply(Matrix2D m)
	{
		...
		double r11 = m.M[1][0] * M[0][0] + m.M[1][1] * M[1][1] + m.M[1][2] * M[2][1];
	 ...
	 * This is equivalent to a left multiplication by a rotation matrix.
	 * @param times The number of 90 degree rotations to perform. This value may be negative.
	 * @return Returns the result stored in this matrix.
	 */
	...
	public Matrix2D Transpose()
	{
		...
		return this;
	}//When switching elements, there should be a temp variable to store one element temporarily
