 ...
 * <br><br>
 * Note that no functions check for exceptions to speedup execution, as this vector is intended for graphical usage.
 * This means exception checking is deferred to the user if desired.
 * @author Dawn Nye
 */
public class Vector2d
{
	...
	public Vector2d(Vector2d v)
	{
		this(v.X,v.X);
		//###
		//The second parameter should be v.Y
		return;
	}
	 ...
	 */
	protected static boolean CloseEnough(double d1, double d2)
	...
	{return CloseEnough(v1.X,v2.X) && CloseEnough(v1.Y,v2.Y);}
	//###
	//Should be static, I think. Though no error
	/**
	...
	{return new Vector2d(X + v.X,Y - v.Y);}
	//###
	//The first parameter should be X - v.X
	...
	//###
	//Should be Y * v for the second parameter
	/**
	...
	{return CloseEnough(X,0.0) && CloseEnough(Y,0.0);}
	...
	public double Magnitude()
	{
		...
		//###
		//Magnitude is not initialized, should use = instead of +=
	}
	...
	//###
	//Error due to malfunction of Magnitude
